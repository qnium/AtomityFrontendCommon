        ...
        value: function applyFilter(filterValue) {
            ...
            if (this.params.complexFilter) {
                ...
                if (filterValue) {
                    ...
                    this.dataProvider.executeAction(this.params.complexFilter.entitiesName, "read", { filter: [complexFilter] }).then(function (result) {
                        ...
                        _this2.dataProvider.errorHandler(err.error);
                    });
                } else {
